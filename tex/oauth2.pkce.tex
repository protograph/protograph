...
\newinst[6]{S}{Resource Server}
	\mess[0]{C}{\shortstack[l]{302 AuthServer: \\CLIENTID, CLIENTURL, SCOPE, CLIENTSTATE,\\ CHALLENGE}}{UA}
	\node [anchor=west] at (mess from) {\shortstack[l]{VERIFIER = SECURE_RNG() \\ CHALLENGE = SHA256(VERIFIER)}};
	\node [anchor=east] at (mess to) {};
	\mess[0]{UA}{\shortstack[l]{POST /auth \\ CLIENTID, CLIENTURL, SCOPE, CLIENTSTATE, CHALLENGE}}{AS}
